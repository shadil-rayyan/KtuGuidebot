...
#from here start s8 for ece
@bot.message_handler(func=lambda message: message.text == "s8")
def s8_ece_button_selected(message):
...
def s8_ece_subject1_button_selected(message):
...
def s8_ece_subject1_note_button_selected(message):
...
def s8_ece_subject1_textbook_selected(message):
...
def s8_ece_subject1_Qp_selected(message):
...
def s8_ece_subject2_button_selected(message):
    nest2_keyboard = ReplyKeyboardMarkup(resize_keyboard=True) 
    nest2_keyboard.row(('Note'))
    nest2_keyboard.row(('Syullbus'))
    nest2_keyboard.row(('Textbook '))
...
@bot.message_handler(func=lambda message: message.text == "module 1")
def s8_ece_subject2_Module1_selected(message):
   #pdf_url = '#' 
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 2")
def s8_ece_subject2_Module2_selected(message):
   #pdf_url = '#' 
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 3")
def s8_ece_subject1_Module3_selected(message):
   ...
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 4")
def s8_ece_subject2_Module4_selected(message):
   #pdf_url = '#' 
   #bot.send_document(message.chat.id,#pdf_url)

@bot.message_handler(func=lambda message: message.text == "module 5")
def s8_ece_subject2_Module5_selected(message):
   #pdf_url = '#' 
    #bot.send.document(message.chat.id,#pdf_url)

# from here start syullbus for s8 m1 
@bot.message_handler(func=lambda message: message.text == "syullbus")
def s8_ece_subject2_Syullbus_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "textbook")
def s8_ece_subject2_textbook_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "Question paper & solved Question paper")
def s8_ece_subject2_Qp_selected(message):
  nest4_keyboard = ReplyKeyboardMarkup(resize_keyboard=True)
  nest4_keyboard.row(("2022"))
  nest4_keyboard.row(('2021'))
  nest4_keyboard.row(("2020"))
...
@bot.message_handler(func=lambda message: message.text == "2022")
def  s8_ece_subject2_Qp2022_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == ('2021'))
def s8_ece_subject2_Qp2021_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "2020")
def s8_ece_subject2_Qp2022_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "Importent topics")
def s8_ece_subject2_Imp_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
...
def s8_ece_subject4_button_selected(message):
    nest2_keyboard = ReplyKeyboardMarkup(resize_keyboard=True) 
    nest2_keyboard.row(('Note'))
    nest2_keyboard.row(('Syullbus'))
    nest2_keyboard.row(('Textbook '))
...
@bot.message_handler(func=lambda message: message.text == "module 1")
def s8_ece_subject3_Module1_selected(message):
   #pdf_url = '#' 
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 2")
def s8_ece_subject3_Module2_selected(message):
   #pdf_url = '#' 
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 3")
def s8_ece_subject1_Module3_selected(message):
   ...
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 4")
def s8_ece_subject3_Module4_selected(message):
   #pdf_url = '#' 
   #bot.send_document(message.chat.id,#pdf_url)

@bot.message_handler(func=lambda message: message.text == "module 5")
def s8_ece_subject3_Module5_selected(message):
   #pdf_url = '#' 
    #bot.send.document(message.chat.id,#pdf_url)

# from here start syullbus for s8 m1 
@bot.message_handler(func=lambda message: message.text == "syullbus")
def s8_ece_subject3_Syullbus_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "textbook")
def s8_ece_subject3_textbook_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "Question paper & solved Question paper")
def s8_ece_subject3_Qp_selected(message):
  nest4_keyboard = ReplyKeyboardMarkup(resize_keyboard=True)
  nest4_keyboard.row(("2022"))
  nest4_keyboard.row(('2021'))
  nest4_keyboard.row(("2020"))
...
@bot.message_handler(func=lambda message: message.text == "2022")
def s8_ece_subject3_Qp2022_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == ('2021'))
def s8_ece_subject3_Qp2021_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "2020")
def s8_ece_subject3_Qp2022_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "Importent topics")
def s8_ece_subject3_Imp_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
...
@bot.message_handler(func=lambda message: message.text == "module 1")
def s8_ece_subject4_Module1_selected(message):
   #pdf_url = '#' 
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 2")
def s8_ece_subject4_Module2_selected(message):
   #pdf_url = '#' 
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 3")
def s8_ece_subject1_Module3_selected(message):
   ...
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 4")
def s8_ece_subject4_Module4_selected(message):
   #pdf_url = '#' 
   #bot.send_document(message.chat.id,#pdf_url)

@bot.message_handler(func=lambda message: message.text == "module 5")
def s8_ece_subject4_Module5_selected(message):
   #pdf_url = '#' 
    #bot.send.document(message.chat.id,#pdf_url)

# from here start syullbus for s8 m1 
@bot.message_handler(func=lambda message: message.text == "syullbus")
def s8_ece_subject4_Syullbus_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "textbook")
def s8_ece_subject4_textbook_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "Question paper & solved Question paper")
def s8_ece_subject4_Qp_selected(message):
  nest4_keyboard = ReplyKeyboardMarkup(resize_keyboard=True)
  nest4_keyboard.row(("2022"))
  nest4_keyboard.row(('2021'))
  nest4_keyboard.row(("2020"))
...
@bot.message_handler(func=lambda message: message.text == "2022")
def s8_ece_subject4_Qp2022_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "2021")
def s8_ece_subject4_Qp2021_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "2020")
def s8_ece_subject4_Qp2022_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "Importent topics")
def s8_ece_subject4_Imp_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
...
def s8_ece_subject5_button_selected(message):
    nest2_keyboard = ReplyKeyboardMarkup(resize_keyboard=True) 
    nest2_keyboard.row(('Note'))
    nest2_keyboard.row(('Syullbus'))
    nest2_keyboard.row(('Textbook '))
...
@bot.message_handler(func=lambda message: message.text == "module 1")
def s8_ece_subject5_Module1_selected(message):
   #pdf_url = '#' 
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 2")
def s8_ece_subject5_Module2_selected(message):
   #pdf_url = '#' 
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 3")
def s8_ece_subject1_Module3_selected(message):
   ...
   #bot.send.document(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "module 4")
def s8_ece_subject5_Module4_selected(message):
   #pdf_url = '#' 
   #bot.send_document(message.chat.id,#pdf_url)

@bot.message_handler(func=lambda message: message.text == "module 5")
def s8_ece_subject5_Module5_selected(message):
   #pdf_url = '#' 
    #bot.send.document(message.chat.id,#pdf_url)

# from here start syullbus for s8 m1 
@bot.message_handler(func=lambda message: message.text == "syullbus")
def s8_ece_subject5_Syullbus_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "textbook")
def s8_ece_subject5_textbook_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "Question paper & solved Question paper")
def s8_ece_subject5_Qp_selected(message):
  nest4_keyboard = ReplyKeyboardMarkup(resize_keyboard=True)
  nest4_keyboard.row(("2022"))
  nest4_keyboard.row(('2021'))
  nest4_keyboard.row(("2020"))
...
@bot.message_handler(func=lambda message: message.text == "2022")
def s8_ece_subject5_Qp2022_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "2021")
def s8_ece_subject5_Qp2021_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)
@bot.message_handler(func=lambda message: message.text == "2020")
def s8_ece_subject5_Qp2022_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "Importent topics")
def s8_ece_subject5_Imp_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)

#....................Lab..................................................
@bot.message_handler(func=lambda message: message.text == "Lab 1")
def s8_ece_Lab1_button_selected(message):
...
@bot.message_handler(func=lambda message: message.text == "Lab 1")
def s8_ece_Lab1_Labmanual_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)

@bot.message_handler(func=lambda message: message.text == "Lab 1")
def s8_ece_Lab1_vivaQuestion_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)

@bot.message_handler(func=lambda message: message.text == "Lab 1")
def s8_ece_Lab1_PracticalRecord_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url

#................Lab 2...............................
@bot.message_handler(func=lambda message: message.text == "Lab 2")
def s8_ece_lab2_button_selected(message):
    nest21_keyboard = ReplyKeyboardMarkup(resize_keyboard=True) 
    nest21_keyboard.row(('Lab manual'))
    nest21_keyboard.row(('Viva Questions'))
    nest21_keyboard.row(('Practical Record'))
...
@bot.message_handler(func=lambda message: message.text == "Lab 1")
def s8_ece_lab2_Labmanual_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)

@bot.message_handler(func=lambda message: message.text == "Lab 1")
def s8_ece_lab2_vivaQuestion_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url)

@bot.message_handler(func=lambda message: message.text == "Lab 1")
def s8_ece_lab2_PracticalRecord_selected(message):
    #pdf_url = '#' 
    #bot.send_photo(message.chat.id,#pdf_url
#.............................................................
@bot.message_handler(func=lambda message: message.text == "Contribute")
def s8_ece_Contribute_selected(message):

    #message_url=''
    #bot.send.message(message.chat.id,message_url)
@bot.message_handler(func=lambda message: message.text == "Whatsapp Group")
def s8_ece_whatsappGroup_selected(message):
    #message_url=''
    #bot.send.message(message.chat.id,message_url)
